...
public class HDAO {
	...
	/**
	 * m�todo para a�adir un NUEVO usuario a la base de datos
	 * 
	 * @param Usuario
	 * @param password
	 * @return
	...
	/**
	 * m�todo para obtener los datos del usuario con nombre pasado por par�metro
	 * 
	 * @param Usuario
	 * @return
	 */
	...
	/**
	 * Comprobar si el usuario y contrase�a son correctos (coinciden con los datos
